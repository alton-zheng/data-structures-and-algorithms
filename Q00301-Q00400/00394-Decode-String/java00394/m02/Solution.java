 ...
 * Memory Usage: 37.1 MB, less than 69.08% of Java online submissions for Decode String.
 */
class Solution {
    public String decodeString(String s) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (cur == ']') {
                ...
                while (!stack.isEmpty() && numStk.size() == stack.size()) {
                    help = new StringBuilder().append(stack.pop()).append(help);
                }
